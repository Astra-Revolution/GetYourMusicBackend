...
urlpatterns = [
    ...
    path('genres/<int:genre_id>/musicians/<int:musician_id>/', musicians_genres, name='musicians_genres'),
    path('instruments/<int:instrument_id>/musicians/<int:musician_id>/', musicians_instruments,
    ...
    path('followers/<int:follower_id>/followed/<int:followed_id>/exists', if_follows, name='if_follows'),
